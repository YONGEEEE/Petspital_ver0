...
import connectDB.NetworkTask_getPetspitalReservationList;
...
public class Petspital_reservation_activity extends AppCompatActivity {
    ListView listView;
    ...
    public void setList() {//리스트뷰 구현
        ...
        try {
            ...
            list = new NetworkTask_getPetspitalReservationList().execute(petspital_name).get();
    ...
    public void show(final Reservation reservation) {
        ...
        builder.setMessage("나이 : "+reservation.getAge()+"\n성별 : "+(reservation.getSex()==1?"수컷":"암컷")+"\n종 : "+reservation.getKind()+"\n정보 : "+reservation.getInform());
...
//                }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            view.setTxt_petspital_name((item.getFlag()==1?"강아지":"고양이"));
            view.setTxt_regdate(item.getRegdate());
            view.setTxt_user_id(item.getUserid());
            return view;
        }
